...
public:
  ...
  /* When an AMPDU is received the window start may change to a new value
   * depending to the sequence number of the received MPDY standard11n page 134
   * this function is used to retrieve this value to add it to the BlockAck
   */
