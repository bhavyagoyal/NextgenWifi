...
public:
  ...
  Ptr<const Packet> PeekNextRetransmitPacket (WifiMacHeader &Hdr,uint8_t tid,Mac48Address recipient);
  void RemoveRetransmitPacket (Ptr<const Packet> p,uint8_t tid,Mac48Address recipient, uint16_t seqnumber);
