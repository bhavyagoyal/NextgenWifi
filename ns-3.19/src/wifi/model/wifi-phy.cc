...
WifiPhy::GetPlcpHtTrainingSymbolDurationMicroSeconds (WifiMode payloadMode, WifiPreamble preamble, WifiTxVector txvector)
{
   switch (preamble)
     ...
     case WIFI_PREAMBLE_HT_MF:
	  ...
	  return 4+ (4* Nltf)+(4*txvector.GetNess());
       }
...
void
WifiPhy::NotifyMonitorSniffRx (Ptr<const Packet> packet, uint16_t channelFreqMhz, uint64_t channelNumber, uint32_t rate, bool isShortPreamble, double signalDbm, double noiseDbm)
{
  m_phyMonitorSniffRxTrace (packet, channelFreqMhz, channelNumber, rate, isShortPreamble, signalDbm, noiseDbm);
}

void
WifiPhy::NotifyMonitorSniffTx (Ptr<const Packet> packet, uint16_t channelFreqMhz, uint64_t channelNumber, uint32_t rate, bool isShortPreamble, uint8_t txPower)
{
...
WifiMode
WifiPhy::GetOfdmRate29_3MbpsBW80MHz ()
{
  static WifiMode mode =
    WifiModeFactory::CreateWifiMode ("OfdmRate29_3MbpsBW80MHz",
                                     WIFI_MOD_CLASS_HT,
                                     false,
                                     80000000, 29300000,
                                     WIFI_CODE_RATE_1_2,
...
WifiMode
WifiPhy::GetOfdmRate58_5MbpsBW80MHz ()
{
  static WifiMode mode =
    WifiModeFactory::CreateWifiMode ("OfdmRate58_5MbpsBW80MHz",
                                     WIFI_MOD_CLASS_HT,
                                     false,
                                     80000000, 58500000,
                                     WIFI_CODE_RATE_1_2,
...
WifiMode
WifiPhy::GetOfdmRate87_8MbpsBW80MHz ()
{
  static WifiMode mode =
    WifiModeFactory::CreateWifiMode ("OfdmRate87_8MbpsBW80MHz",
                                     WIFI_MOD_CLASS_HT,
                                     false,
                                     80000000, 87800000,
                                     WIFI_CODE_RATE_3_4,
...
WifiMode
WifiPhy::GetOfdmRate117MbpsBW80MHz ()
{
  static WifiMode mode =
    WifiModeFactory::CreateWifiMode ("OfdmRate117MbpsBW80MHz",
                                     WIFI_MOD_CLASS_HT,
                                     false,
                                     80000000, 117000000,
                                     WIFI_CODE_RATE_1_2,
...
WifiMode
WifiPhy::GetOfdmRate175_5MbpsBW80MHz ()
{
  static WifiMode mode =
    WifiModeFactory::CreateWifiMode ("OfdmRate175_5MbpsBW80MHz",
                                     WIFI_MOD_CLASS_HT,
                                     false,
                                     80000000, 175500000,
                                     WIFI_CODE_RATE_3_4,
...
WifiMode
WifiPhy::GetOfdmRate234MbpsBW80MHz ()
{
  static WifiMode mode =
    WifiModeFactory::CreateWifiMode ("OfdmRate234MbpsBW80MHz",
                                     WIFI_MOD_CLASS_HT,
                                     false,
                                     80000000, 234000000,
                                     WIFI_CODE_RATE_2_3,
...
WifiMode
WifiPhy::GetOfdmRate263_3MbpsBW80MHz ()
{
  static WifiMode mode =
    WifiModeFactory::CreateWifiMode ("OfdmRate263_3MbpsBW80MHz",
                                     WIFI_MOD_CLASS_HT,
                                     false,
                                     80000000, 263300000,
                                     WIFI_CODE_RATE_3_4,
...
WifiMode
WifiPhy::GetOfdmRate292_5MbpsBW80MHz ()
{
  static WifiMode mode =
    WifiModeFactory::CreateWifiMode ("OfdmRate292_5MbpsBW80MHz",
                                     WIFI_MOD_CLASS_HT,
                                     false,
                                     80000000, 292500000,
                                     WIFI_CODE_RATE_5_6,
